      ...
      <div className="mt-6 space-y-4">
        <div className="flex justify-between items-center">
          ...
          <div className="text-right">
            <p
              className={
                calculateChangeRate(stock[2023], stock[2024])[0] == "↑"
                  ? "text-green-500 "
                  : "text-red-500"
              }
            >
              {calculateChangeRate(stock[2023], stock[2024])}
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500">
              {formattedMarketCap(expenses[2024])}
            </p>
          </div>
          <div className="text-right">
            <p
              className={
                calculateChangeRate(expenses[2023], expenses[2024])[0] == "↑"
                  ? "text-green-500 "
                  : "text-red-500"
              }
            >
              {calculateChangeRate(expenses[2023], expenses[2024])}
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500">
              {formattedMarketCap(revenue[2024])}
            </p>
          </div>
          <div className="text-right">
            <p
              className={
                calculateChangeRate(revenue[2023], revenue[2024])[0] == "↑"
                  ? "text-green-500 "
                  : "text-red-500"
              }
            >
              {calculateChangeRate(revenue[2023], revenue[2024])}
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="text-right">
            <p
              className={
                calculateChangeRate(marketShare[2023], marketShare[2024])[0] ==
                "↑"
                  ? "text-green-500 "
                  : "text-red-500"
              }
            >
              {calculateChangeRate(marketShare[2023], marketShare[2024])}
            </p>
          </div>
        </div>
      </div>
